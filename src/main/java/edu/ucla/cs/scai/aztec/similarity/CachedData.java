...
import edu.ucla.cs.scai.aztec.similarity.TfIdfBuilder;
...
public class CachedData {
    ...
    static HashMap<String, LinkedList<RankedString>> idkeywords;

    private static void loadTfidfData() throws Exception {
        System.out.println("TF/IDF load path system property: " + System.getProperty("tfidf.path"));
    ...
    private static void buildTfidfData() throws Exception {
        System.out.println("TF/IDF  build path system property: " + System.getProperty("tfidf.path"));
        String tfidtPath = System.getProperty("tfidf.path", "src/main/data/tfidf.data");
    ...
    private static void loadKeywords() throws Exception {
        ...
        keywords = (HashMap<String, LinkedList<RankedString>>) ois.readObject();
    }
    ...
    private static void loadidKeywords() throws Exception {
        System.out.println("Load IdKeywords path system property: " + System.getProperty("idkeywords.path"));
        String keywordsPath = System.getProperty("idkeywords.path", "src/main/data/idkeywords.data");
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream(keywordsPath));
        idkeywords = (HashMap<String, LinkedList<RankedString>>) ois.readObject();
    }

    private static void buildidKeywords() throws Exception {
        System.out.println("Build IdKeywords path system property: " + System.getProperty("idkeywords.path"));
        String keywordsPath = System.getProperty("idkeywords.path", "src/main/data/idkeywords.data");
        IndentityAttrBuilder builder = new IndentityAttrBuilder();
        idkeywords = builder.buildIDTF(entryArray, keywordsPath);
    }
